...
student_1.rate_hw(best_lecturer_1, 'Python', 1)
student_1.rate_hw(best_lecturer_1, 'Python', 2)
student_1.rate_hw(best_lecturer_1, 'Python', 0)
...
student_2.rate_hw(best_lecturer_2, 'Java', 2)
...
cool_rewiewer_1.rate_hw(student_1, 'Python', 3)

cool_rewiewer_2.rate_hw(student_2, 'Java', 8)
cool_rewiewer_2.rate_hw(student_2, 'Java', 0)
